...
const EXPLORE_CATEGORIES = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1596040033229-a0b4e27d6396?auto=format&fit=crop&w=1600&q=80",
    route: "/explore/foods",
  },
  {
    number: "06",
...
const HERO_CONTENT = {
  ...
  detail: createBilingualContent(
    "Celebrate the Pandya fish, Chola tiger, and Pallava bull emblems that still guard temples, astronomy, dance, and poetry across Tamilakam.",
    "பாண்டிய மீன்கொடி, சோழப் புலி, பல்லவ நந்தி ஆகிய சின்னங்கள் கோவில்கள், விண்கலை, நடனங்கள், இலக்கியம் வரை தமிழகத்தை எவ்வாறு காக்கின்றன என்பதை கொண்டாடுங்கள்."
  ),
...
export default function Home() {
  ...
  return (
    <Box sx={{ bgcolor: "#fff", color: "#111", fontFamily: "'Inter', 'Arial', sans-serif" }}>
      ...
      >
        <Container maxWidth="xl" sx={{ px: { xs: 3, sm: 4, md: 6, lg: 8 }, position: 'relative', zIndex: 2 }}>
          <Box
            sx={{
              display: 'flex',
            ...
            <Container maxWidth="xl" sx={{ px: { xs: 3, sm: 4, md: 6, lg: 8 } }}>
              ...
              >
                ...
                >
                  ...
                  >
                    {i18n.language === 'ta' ? 'ஆங்கில மொழிபெயர்ப்பு' : 'Translation'}
                  </Typography>
                  <Typography
                    variant="body1"
                    sx={{
                      lineHeight: 1.8,
                      color: 'rgba(45,20,8,0.85)',
                      fontStyle: 'italic'
                    }}
                  >
                    {FEATURED_KURAL.translation}
                  </Typography>
                </Paper>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap' }}>
                    <FormatQuoteRounded sx={{ fontSize: 42, color: '#b1560f' }} />
                    <Typography
                      variant="overline"
                      sx={{
                        letterSpacing: 5,
                ...
                >
                  ...
                  >
                    <Box>
                      ...
                      >
                        Tamil Archaeology Labs & Field Conservation
                      </Typography>
                    </Box>
                    ...
                    >
                      From furnace slag in Kodumanal to maritime beads at Poompuhar, our archaeology teams decode the Tamil Iron Age with lab-grade precision. Specialists catalogue palm-leaf inscriptions, conserve megalithic burials, and map ancient trade routes that connected the Tamil coast with Rome and Southeast Asia.
                    </Typography>
                    ...
                    >
                      Join digs that blend GIS scanning, metallurgical analysis, and oral histories with village elders to rebuild the continuum of Tamil civilization.
                    </Typography>
      ...
      {/* LIBRARY & ARCHIVES */}
      <Box ref={libraryRef} sx={{ bgcolor: '#fff', py: { xs: 10, md: 13 } }}>
        <Container
          maxWidth="xl"
          sx={{
                  ...
                  {LIBRARY_ARCHIVES_DESCRIPTION_SEGMENTS.map((segment, idx) => (
                    <Box
                      ...
                      sx={{
                        ...
                        color: segment.highlight ? '#6f2f2f' : 'inherit'
                      }}
                    >
      ...
      {/* STATISTICS SECTION */}
      <Box sx={{ py: { xs: 10, md: 14 }, bgcolor: "#000", color: "#fff" }}>
          ...
          <Grid container spacing={4} justifyContent="center">
            <Grid item xs={6} md={3}>
              <Box sx={{ textAlign: "center", py: 2 }}>
                ...
                <Typography variant="body1" sx={{ fontWeight: 500, color: "#999", fontSize: { xs: "0.9rem", md: "1rem" }, textTransform: "uppercase", letterSpacing: 1, whiteSpace: "nowrap" }}>
                  {t('home.stats.artifacts')}
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={6} md={3}>
              <Box sx={{ textAlign: "center", py: 2 }}><Typography variant="h1" sx={{ fontWeight: 900, mb: 1, fontSize: { xs: "2.5rem", sm: "3.5rem", md: "4rem" },
                    color: "#DAA520",
                    lineHeight: 1
                  }}
                >
            ...
            {TEAM_MUSEUM.map((member, index) => (
              <Grid item xs={6} sm={4} md={2.4} key={index}>
                ...
                >
                  ...
                  <Typography variant="h6" sx={{ fontWeight: 700, mb: 0.5, color: "#fff", fontSize: { xs: "0.9rem", md: "0.95rem" }, lineHeight: 1.2 }}>
                    {member.name[i18n.language] || member.name.en}
                  </Typography>
                  <Typography variant="body2" sx={{ color: "#aaa", fontWeight: 500, fontSize: "0.8rem", lineHeight: 1.4, px: 0.5 }}>
